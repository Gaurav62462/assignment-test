...
const NavBar = () => {
  ...
  const IconButton = (props: any) => {
    const { path } = props || {}
    return (<CustomButton className="text-[14px] font-medium flex justify-center items-center">
  ...
  return (
    <nav className="p-5 bg-[#FFFFFF] flex items-center justify-between flex-wrap px-6">
      ...
      <div className={`absolute md:static top-[60px] left-0 w-full md:w-auto bg-white md:bg-transparent p-4 md:p-0 shadow-md md:shadow-none flex flex-col md:flex-row md:items-center gap-2 transition-all duration-300 ${
